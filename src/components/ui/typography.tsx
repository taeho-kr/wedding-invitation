...
const Typography = ({ variant, children, className, style, title }: TypographyProps) => {
	...
	switch (variant) {
		...
		case 'display2':
			...
			break;
		case 'title2':
			computedClassName = 'text-[1.75rem] font-extrabold';
			break;
		case 'title3':
		...
		case 'caption2':
			...
			break;
		case 'body1':
			computedClassName = 'text-[0.9375rem] font-medium ';
			break;
		case 'body2':
			computedClassName = 'text-[0.9375rem] font-bold ';
			break;
		default:
			break;
	}
